...
# warning it means it will capture everything that is a warning,critical,error and ignore info and debug because our
# logging default level is warning and ignore debug and info we change this default setting using logging config
...
logging.basicConfig(filename='debug.log', level=logging.DEBUG, format='%(asctime)%:%(levelname)%:%(message)%')
